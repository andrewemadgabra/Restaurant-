...
fillRestaurantHTML = (restaurant = self.restaurant) => {
    ...
    image.setAttribute("alt","some people eating");
    image.setAttribute("alt","The pizza  restaurant");
    image.setAttribute("alt","Restaurant lounge");
    image.setAttribute("alt","restaurant Katzs");
    image.setAttribute("alt","stuff that work on resturant");
